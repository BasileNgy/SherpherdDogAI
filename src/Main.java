public class Main {
    ...
    public static void main(String[] args)
    {
        ...
        Dog dog1 = new Dog(1,enclosAStar, enclosAStar.color, enclosMiniMax.color, enclosAStar.x, enclosAStar.y);
        Dog dog2 = new Dog(1,enclosMiniMax, enclosMiniMax.color, enclosAStar.color, enclosMiniMax.x, enclosMiniMax.y);
